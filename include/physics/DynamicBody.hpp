...
/// ease the instantiation and use of Box2D dynamic bodies.
...
class DynamicBody
{
    ...
    public:
        //////////////////////////////////////////
        /// \fn DynamicBody(b2World* world, GLRect rect)
        /// \brief Preferred constructor for a
        /// DynamicBody.
        //////////////////////////////////////////
        DynamicBody(b2World* world, GLRect rect);
        ...
        //////////////////////////////////////////
        void setDensity(float density){ m_body->GetFixtureList()[0].SetDensity(density); m_body->ResetMassData(); };
        ...
        /// \brief Set the position of the DynamicBody.
        ...
        /// \brief Get the rotation of the DynamicBody.
        ...
        ///////////////////////////////////////////
        /// \fn void destroyBody()
        /// \brief Destroy the DynamicBody. Safely
